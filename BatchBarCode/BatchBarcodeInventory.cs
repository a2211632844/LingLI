    ...
    class BatchBarcodeInventory
    {
        ...
        public static string JsonAdd(string jsonArrayText, string user, string psw, string dbid, string apiurl)
        {
            ...
            if (loginResult == true)
            {
                ...
                model.Add("F_LLL_FXDate", jo["F_LLL_JHDDRQ"]);
                model.Add("F_LLL_HTPHTX", jo["F_LLL_HTPHTX"]);//虎头批号碳性
                model.Add("F_LLL_JXBGJDate", jo["F_LLL_JXBGJDate"]);//碱性不干胶日期
                model.Add("F_LLL_SYM",jo["F_LLL_SYM"]);
                model.Add("F_LLL_XSDDH", jo["F_LLL_XSDDH"]);
                model.Add("F_LLL_KHHTH", jo["F_LLL_KHHTH"]);
